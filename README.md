...
Sekunden mit der gemeinsamen Liste ab (Supabase). Das iPhone nutzt die Web-App im Ordner `docs/` (GitHub Pages: https://zweisebastian.github.io/einkauf/) mit demselben Code.
