...
Sekunden mit der gemeinsamen Liste ab (Supabase). Das iPhone nutzt die Web-App im Ordner `docs/` (GitHub Pages: https://zweisebastian.github.io/einkauf/) mit demselben Code. Die Web-App ist auf Englisch, die Android-App auf Deutsch – der Abgleich ist davon unabhängig.
